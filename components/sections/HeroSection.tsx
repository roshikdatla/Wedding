...
export function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center py-12 bg-gradient-to-b from-gray-900 to-transparent">
        <motion.div
      ...
      <div className="relative flex flex-1">
        ...
        <a
          ...
          className="relative w-1/3 flex flex-col items-center justify-start pt-20 cursor-pointer transition-transform hover:scale-105 group"
        >
          ...
          <div className="relative z-10 text-center px-4">
            ...
            >
              <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-white mb-2">
            ...
            <motion.div
              ...
              className="mt-6"
            >
              <span className="inline-block px-6 py-2 bg-white/20 backdrop-blur-sm rounded-full border-2 border-white/40 text-white font-semibold group-hover:bg-white/30 transition-all">
                Click for Details →
              </span>
            </motion.div>
          </div>
        ...
        <div className="relative w-1/3 flex flex-col items-center justify-start pt-20 bg-gray-400">
          <div className="absolute inset-0 bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700 opacity-50">
            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
          </div>

          <div className="relative z-10 text-center px-4">
            <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-white/60 mb-2">
              Engagement
            </h2>
            ...
            <p className="text-xl md:text-2xl text-white/70 font-semibold mb-2">
              TBD
            </p>
        ...
        <div className="relative w-1/3 flex flex-col items-center justify-start pt-20 bg-gray-500">
